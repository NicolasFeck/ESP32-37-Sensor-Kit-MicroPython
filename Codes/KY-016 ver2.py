...
red_led = PWM(Pin(32), freq=1000) #With a 68 ohm resistor
green_led = PWM(Pin(33), freq=1000) #With a 10 ohm resistor
blue_led = PWM(Pin(25), freq=1000) #With a 10 ohm resistor
